...
modelnum = 90
# Input paths
parser.add_argument('--model', type=str, default='save/rl_c2f_att_2/model-%d.pth' % modelnum,
                    help='path to model to evaluate')
parser.add_argument('--cnn_model', type=str, default='resnet101',
                    help='resnet101, resnet152')
parser.add_argument('--infos_path', type=str, default='save/rl_c2f_att_2/infos_%d.pkl' % modelnum,
...
model.cuda()
model.eval()
crit = utils.c2fLanguageModelCriterion()
...
if opt.dump_json == 1:
    # dump the json
    json.dump(split_predictions, open('vis/vis_{}_{}.json'.format(opt.split, modelnum), 'w'),
