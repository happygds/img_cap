...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default='save/rl_c2f_att64_glove',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='save/rl_c2f_att64_glove',
    ...
    # misc
    parser.add_argument('--id', type=str, default='37',
