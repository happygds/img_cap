...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default='save/c2f_att',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='save/rl_c2f_att_fine',
    ...
    # misc
    parser.add_argument('--id', type=str, default='39',
