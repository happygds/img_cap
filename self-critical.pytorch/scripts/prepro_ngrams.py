...
def main(params):
  ...
  cPickle.dump({'document_frequency': ngram_words, 'ref_len': ref_len}, open(
      params['output_pkl'] + '-words.p', 'w'), protocol=cPickle.HIGHEST_PROTOCOL)
  cPickle.dump({'document_frequency': ngram_idxs, 'ref_len': ref_len}, open(
      params['output_pkl'] + '-idxs.p', 'w'), protocol=cPickle.HIGHEST_PROTOCOL)
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='./data/dataset_ai.json',
                      help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='./data/aitalk.json', help='output json file')
  parser.add_argument('--output_pkl', default='./data/ai-train', help='output pickle file')
